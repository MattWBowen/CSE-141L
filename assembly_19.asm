# lookup #127		#acc = 127 mem&. TODO: change syntax of key
# put $r11		#returnReg = 127 mem&
# lookup #1       #TODO: change syntax of key
# add $r11		#acc = 128 mem&
...
Binomial1:				#for loop from i=0 to 18 (19 times not 20)
	...
	Binomial2:			#for loop from j=i+1 to 19
		...
		CheckLSB:		#for loop from byte = 0 to 7 (8bits)
			lookup #1		#mask. TODO: change syntax of key
			...
			lookup #8       #TODO: change syntax of key
		...
		sub $r10		#acc = j-129
		put $r10		#temp = j-129
		lookup #20      #TODO: change syntax of key
		put $r7			#temp2 = 20
